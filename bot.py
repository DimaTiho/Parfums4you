...
main_menu_buttons = [
    ...
    InlineKeyboardButton("📉Знижка дня", callback_data="daily_discount"), [InlineKeyboardButton("ℹ️Як замовити?", callback_data="how_to_order")],
    [InlineKeyboardButton("💬Відгуки", callback_data="reviews")), [InlineKeyboardButton("🛒 Кошик", callback_data="show_cart")}
